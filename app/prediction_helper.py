...
column_names = joblib.load(r'app\artifacts\columns.joblib')
...
def calculate_normalized_risk_score(medical_history):
    ...
    total_risk_score = sum(risk_scores.get(disease, 0) for disease in diseases)   # Default to 0 if disease is not found
...
def handle_scaling(age, df):
    # scale age and income_lakhs columns
    if age <= 25:
